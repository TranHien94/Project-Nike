        ...
        <div className="login_container">
            ...
            <form onSubmit={async (e) => {
                ...
                <div className="form-control">
                    ...
                    <input type="text" name="user_name" id="userName" placeholder="User name or Email" autoComplete="username" />
                </div>
                <div className="form-control">
                ...
                <button type="button" className="back_btn" onClick={() => navigate('/')}>Back to Home</button>
            </form>
        </div>
    );
}